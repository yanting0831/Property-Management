	...
	<div class="sidebar">
		<header><img src="images/dryx-black.png" alt="dryx-logo" width="50%"></header>
			<ul>
				...
				<li><a href="payment-log.php"><i class="fas fa-money-bill-alt"></i>Payment Log</a></li>
				<li><a href="visitor-log.php"><i class="fas fa-address-card"></i>Visitor Log</a></li>
				<li><a href="Cannouncement.php"><i class="fas fa-bell"></i>Announcements</a></li>
